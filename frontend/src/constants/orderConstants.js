...
export const ALL_ORDERS_COLLECTOR_REQUEST = "ALL_ORDERS_COLLECTOR_REQUEST";
export const ALL_ORDERS_COLLECTOR_SUCCESS = "ALL_ORDERS_COLLECTOR_SUCCESS";
export const ALL_ORDERS_COLLECTOR_FAIL = "ALL_ORDERS_COLLECTOR_FAIL";
